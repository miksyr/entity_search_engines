...
class Entity:
    ...
    def __init__(self, entityName: str, entityType: str = None, wikiId: str = None, wikidataDescription: str = None, googleId: str = None, googleDescription: str = None, surfaceForms: Sequence[str] = None):
        """
    ...
    def set_entity_source(self, entitySource: str):
        """
    ...
    @property
    def wikiUrl(self):
        return WIKIDATA_GET_LINK.format(self.wikiId) if self.wikiId is not None else None

    @property
    def googleSearchUrl(self):
